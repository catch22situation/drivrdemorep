...
@RestController
@RequestMapping("/api/drivrdemo-kafka")
public class DrivrdemoKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DrivrdemoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DrivrdemoKafkaResource(KafkaProperties kafkaProperties) {
